...
(* ALTERA_ATTRIBUTE = "-name SDC_STATEMENT \"set_false_path -from [get_cells -compatibility_mode *\|alt_cal_channel\[*\]] \";-name SDC_STATEMENT \"set_false_path -from [get_cells -compatibility_mode *\|alt_cal_busy] \";suppress_da_rule_internal=\"C101,C103,C104,C106,D101\";-name MESSAGE_DISABLE \"19017\"" *) module alt_cal (
	clock,
	reset,
	start,
	transceiver_init,
