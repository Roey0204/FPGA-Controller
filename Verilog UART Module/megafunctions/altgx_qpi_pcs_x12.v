...
// 30-Jul-2009 ishimony - lc_clk sent directly to transmit_pma0-11 and
//                        central_clk_div0-2
// 23-Nov-2009 ejulias  - Modified for Intel's QPI implementation
// 31-Dec-2009 ejulias  - Swaps the quad order so that the user visible channel order
//                        matches the pin table channel order
//
...
//
//
//  non LC (CMU) Clocking (partial diagram...)
//
//    pll_inclk                                                +------------+
//        |                                               +--->| tx_pma  7  |
//        |                                               |    +------------+
...
output [11:0]  rx_signaldetect;
input  [12 * 32 - 1:0] tx_datain;
output [11:0]  tx_dataout;
input          tx_digitalreset;
input  [11:0]  tx_forceelecidle;
...
tri0   [12 * 32 - 1:0] tx_datain;
tri0           tx_digitalreset;
tri0   [11:0]  tx_forceelecidle;
...
parameter   m                       = 8;
parameter   n                       = 1;
parameter   input_clock_frequency   = "300.0 MHz";
parameter   input_clock_period      = 3333; //pSec: 1e6 / input_clock_frequency
parameter   effective_data_rate     = "4800 Mbps";

// The following constants define how to swap the quad/channel order so that it will match the channel order
// as defined in the pin table. This makes pin placement easier as you can just place the HSSI pins linearly
// starting from the bottom channel
localparam  match_placement_order                = "yes";
localparam  quad0_number                         = match_placement_order == "yes" ? 1 : 0;
localparam  quad0_starting_channel_number_offset = quad0_number * 4;
localparam  quad1_number                         = match_placement_order == "yes" ? 2 : 1;
localparam  quad1_starting_channel_number_offset = quad1_number * 4;
localparam  quad2_number                         = match_placement_order == "yes" ? 0 : 2;
localparam  quad2_starting_channel_number_offset = quad2_number * 4;
...
wire           wire_receive_pcs8_signaldetect;
...
wire           wire_receive_pcs9_signaldetect;
...
wire           wire_receive_pcs10_signaldetect;
...
wire           wire_receive_pcs11_signaldetect;
...
wire           wire_transmit_pcs8_forceelecidleout;
...
wire           wire_transmit_pcs9_forceelecidleout;
...
wire           wire_transmit_pcs10_forceelecidleout;
...
wire           wire_transmit_pcs11_forceelecidleout;
...
wire [11:0]    rx_signaldetectout_wire;
wire [5399:0]   rxpll_dprioin;
wire [17:0]    tx_analogreset_out;
wire [11:0]    tx_coreclk_in;
wire [12 * 32 - 1:0]   tx_datain_wire;
...
wire [11:0]    tx_pcs_forceelecidleout;
...
assign
	wire_tx_digitalreset_reg0c_d = {tx_digitalreset_reg0c[1:0], tx_digitalreset};
assign
...
stratixiv_hssi_clock_divider   central_clk_div2 (
    ...
    .dprioin(cent_unit_cmudividerdprioout[1699:1600]),
...
defparam
    ...
    cent_unit0.devaddr = ((((starting_channel_number + quad0_starting_channel_number_offset) / 4) % 32) + 1),
    ...
    cent_unit0.portaddr = (((starting_channel_number + quad0_starting_channel_number_offset) / 128) + 1),
...
defparam
    ...
    cent_unit1.devaddr = ((((starting_channel_number + quad1_starting_channel_number_offset) / 4) % 32) + 1),
    ...
    cent_unit1.portaddr = (((starting_channel_number + quad1_starting_channel_number_offset) / 128) + 1),
...
defparam
    ...
    cent_unit2.devaddr = ((((starting_channel_number + quad2_starting_channel_number_offset) / 4) % 32) + 1),
    ...
    cent_unit2.portaddr = (((starting_channel_number + quad2_starting_channel_number_offset) / 128) + 1),
...
defparam
    ...
    rx_cdr_pll0.channel_num = (((starting_channel_number + quad0_starting_channel_number_offset) + 0) % 4),
...
defparam
    ...
    rx_cdr_pll1.channel_num = (((starting_channel_number + quad0_starting_channel_number_offset) + 1) % 4),
...
defparam
    ...
    rx_cdr_pll2.channel_num = (((starting_channel_number + quad0_starting_channel_number_offset) + 2) % 4),
...
defparam
    ...
    rx_cdr_pll3.channel_num = (((starting_channel_number + quad0_starting_channel_number_offset) + 3) % 4),
...
defparam
    ...
    rx_cdr_pll4.channel_num = (((starting_channel_number + quad1_starting_channel_number_offset) + 0) % 4),
...
defparam
    ...
    rx_cdr_pll5.channel_num = (((starting_channel_number + quad1_starting_channel_number_offset) + 1) % 4),
...
defparam
    ...
    rx_cdr_pll6.channel_num = (((starting_channel_number + quad1_starting_channel_number_offset) + 2) % 4),
...
defparam
    ...
    rx_cdr_pll7.channel_num = (((starting_channel_number + quad1_starting_channel_number_offset) + 3) % 4),
...
stratixiv_hssi_pll   rx_cdr_pll8 (
    ...
    .dpriodisable(w_cent_unit_dpriodisableout1w[2]),
    .dprioin(rxpll_dprioin[3899:3600]),
...
defparam
    rx_cdr_pll8.bandwidth_type = "Auto",
    rx_cdr_pll8.channel_num = (((starting_channel_number + quad2_starting_channel_number_offset) + 0) % 4),
    rx_cdr_pll8.dprio_config_mode = 6'h00,
    rx_cdr_pll8.effective_data_rate = effective_data_rate,
    rx_cdr_pll8.enable_dynamic_divider = "false",
    rx_cdr_pll8.fast_lock_control = "false",
...
stratixiv_hssi_pll   rx_cdr_pll9 (
    ...
    .dpriodisable(w_cent_unit_dpriodisableout1w[2]),
    .dprioin(rxpll_dprioin[4199:3900]),
...
defparam
    rx_cdr_pll9.bandwidth_type = "Auto",
    rx_cdr_pll9.channel_num = (((starting_channel_number + quad2_starting_channel_number_offset) + 1) % 4),
    rx_cdr_pll9.dprio_config_mode = 6'h00,
    rx_cdr_pll9.effective_data_rate = effective_data_rate,
    rx_cdr_pll9.enable_dynamic_divider = "false",
    rx_cdr_pll9.fast_lock_control = "false",
...
stratixiv_hssi_pll   rx_cdr_pll10 (
    ...
    .dpriodisable(w_cent_unit_dpriodisableout1w[2]),
    .dprioin(rxpll_dprioin[4499:4200]),
...
defparam
    rx_cdr_pll10.bandwidth_type = "Auto",
    rx_cdr_pll10.channel_num = (((starting_channel_number + quad2_starting_channel_number_offset) + 2) % 4),
    rx_cdr_pll10.dprio_config_mode = 6'h00,
    rx_cdr_pll10.effective_data_rate = effective_data_rate,
    rx_cdr_pll10.enable_dynamic_divider = "false",
    rx_cdr_pll10.fast_lock_control = "false",
...
stratixiv_hssi_pll   rx_cdr_pll11 (
    ...
    .dpriodisable(w_cent_unit_dpriodisableout1w[2]),
    .dprioin(rxpll_dprioin[4799:4500]),
...
defparam
    rx_cdr_pll11.bandwidth_type = "Auto",
    rx_cdr_pll11.channel_num = (((starting_channel_number + quad2_starting_channel_number_offset) + 3) % 4),
    rx_cdr_pll11.dprio_config_mode = 6'h00,
    rx_cdr_pll11.effective_data_rate = effective_data_rate,
    rx_cdr_pll11.enable_dynamic_divider = "false",
    rx_cdr_pll11.fast_lock_control = "false",
...
stratixiv_hssi_rx_pcs   receive_pcs0 (
    ...
    .cdrctrlearlyeios(),
    .cdrctrllocktorefcl((reconfig_togxb_busy | rx_locktorefclk[quad0_starting_channel_number_offset + 0])),
...
defparam
    ...
    receive_pcs0.channel_number = (((starting_channel_number + quad0_starting_channel_number_offset) + 0) % 4),
    ...
    receive_pcs0.logical_channel_address = ((starting_channel_number + quad0_starting_channel_number_offset) + 0),
...
stratixiv_hssi_rx_pcs   receive_pcs1 (
    ...
    .byteorderalignstatus(),
    .cdrctrlearlyeios(),
    .cdrctrllocktorefcl((reconfig_togxb_busy | rx_locktorefclk[quad0_starting_channel_number_offset + 1])),
...
defparam
    ...
    receive_pcs1.channel_number = (((starting_channel_number + quad0_starting_channel_number_offset) + 1) % 4),
    receive_pcs1.channel_width = 32,
    ...
    receive_pcs1.logical_channel_address = ((starting_channel_number + quad0_starting_channel_number_offset) + 1),
...
stratixiv_hssi_rx_pcs   receive_pcs2 (
    ...
    .byteorderalignstatus(),
    .cdrctrlearlyeios(),
    .cdrctrllocktorefcl((reconfig_togxb_busy | rx_locktorefclk[quad0_starting_channel_number_offset + 2])),
...
defparam
    ...
    receive_pcs2.channel_number = (((starting_channel_number + quad0_starting_channel_number_offset) + 2) % 4),
    receive_pcs2.channel_width = 32,
    ...
    receive_pcs2.logical_channel_address = ((starting_channel_number + quad0_starting_channel_number_offset) + 2),
...
stratixiv_hssi_rx_pcs   receive_pcs3 (
    ...
    .byteorderalignstatus(),
    .cdrctrlearlyeios(),
    .cdrctrllocktorefcl((reconfig_togxb_busy | rx_locktorefclk[quad0_starting_channel_number_offset + 3])),
...
defparam
    ...
    receive_pcs3.channel_number = (((starting_channel_number + quad0_starting_channel_number_offset) + 3) % 4),
    receive_pcs3.channel_width = 32,
    ...
    receive_pcs3.logical_channel_address = ((starting_channel_number + quad0_starting_channel_number_offset) + 3),
...
stratixiv_hssi_rx_pcs   receive_pcs4 (
    ...
    .byteorderalignstatus(),
    .cdrctrlearlyeios(),
    .cdrctrllocktorefcl((reconfig_togxb_busy | rx_locktorefclk[quad1_starting_channel_number_offset + 0])),
...
defparam
    ...
    receive_pcs4.channel_number = (((starting_channel_number + quad1_starting_channel_number_offset) + 0) % 4),
    receive_pcs4.channel_width = 32,
    ...
    receive_pcs4.logical_channel_address = ((starting_channel_number + quad1_starting_channel_number_offset) + 0),
...
stratixiv_hssi_rx_pcs   receive_pcs5 (
    ...
    .byteorderalignstatus(),
    .cdrctrlearlyeios(),
    .cdrctrllocktorefcl((reconfig_togxb_busy | rx_locktorefclk[quad1_starting_channel_number_offset + 1])),
...
defparam
    ...
    receive_pcs5.channel_number = (((starting_channel_number + quad1_starting_channel_number_offset) + 1) % 4),
    receive_pcs5.channel_width = 32,
    ...
    receive_pcs5.logical_channel_address = ((starting_channel_number + quad1_starting_channel_number_offset) + 1),
...
stratixiv_hssi_rx_pcs   receive_pcs6 (
    ...
    .byteorderalignstatus(),
    .cdrctrlearlyeios(),
    .cdrctrllocktorefcl((reconfig_togxb_busy | rx_locktorefclk[quad1_starting_channel_number_offset + 2])),
...
defparam
    ...
    receive_pcs6.channel_number = (((starting_channel_number + quad1_starting_channel_number_offset) + 2) % 4),
    receive_pcs6.channel_width = 32,
    ...
    receive_pcs6.logical_channel_address = ((starting_channel_number + quad1_starting_channel_number_offset) + 2),
...
stratixiv_hssi_rx_pcs   receive_pcs7 (
    ...
    .byteorderalignstatus(),
    .cdrctrlearlyeios(),
    .cdrctrllocktorefcl((reconfig_togxb_busy | rx_locktorefclk[quad1_starting_channel_number_offset + 3])),
...
defparam
    ...
    receive_pcs7.channel_number = (((starting_channel_number + quad1_starting_channel_number_offset) + 3) % 4),
    receive_pcs7.channel_width = 32,
    ...
    receive_pcs7.logical_channel_address = ((starting_channel_number + quad1_starting_channel_number_offset) + 3),
...
stratixiv_hssi_rx_pcs   receive_pcs8 (
    ...
    .byteorderalignstatus(),
    .cdrctrlearlyeios(),
    .cdrctrllocktorefcl((reconfig_togxb_busy | rx_locktorefclk[quad2_starting_channel_number_offset + 0])),
    ...
    .rxdetectvalid(1'b0),
    .rxfound(2'b00),
    .signaldetect(wire_receive_pcs8_signaldetect),
...
defparam
    ...
    receive_pcs8.channel_number = (((starting_channel_number + quad2_starting_channel_number_offset) + 0) % 4),
    receive_pcs8.channel_width = 32,
    receive_pcs8.clk1_mux_select = "recovered clock",
    receive_pcs8.clk2_mux_select = "recovered clock",
    receive_pcs8.core_clock_0ppm = "false",
    ...
    receive_pcs8.logical_channel_address = ((starting_channel_number + quad2_starting_channel_number_offset) + 0),
...
stratixiv_hssi_rx_pcs   receive_pcs9 (
    ...
    .byteorderalignstatus(),
    .cdrctrlearlyeios(),
    .cdrctrllocktorefcl((reconfig_togxb_busy | rx_locktorefclk[quad2_starting_channel_number_offset + 1])),
    ...
    .rxdetectvalid(1'b0),
    .rxfound(2'b00),
    .signaldetect(wire_receive_pcs9_signaldetect),
...
defparam
    ...
    receive_pcs9.channel_number = (((starting_channel_number + quad2_starting_channel_number_offset) + 1) % 4),
    receive_pcs9.channel_width = 32,
    receive_pcs9.clk1_mux_select = "recovered clock",
    receive_pcs9.clk2_mux_select = "recovered clock",
    receive_pcs9.core_clock_0ppm = "false",
    ...
    receive_pcs9.logical_channel_address = ((starting_channel_number + quad2_starting_channel_number_offset) + 1),
...
stratixiv_hssi_rx_pcs   receive_pcs10 (
    ...
    .byteorderalignstatus(),
    .cdrctrlearlyeios(),
    .cdrctrllocktorefcl((reconfig_togxb_busy | rx_locktorefclk[quad2_starting_channel_number_offset + 2])),
    ...
    .rxdetectvalid(1'b0),
    .rxfound(2'b00),
    .signaldetect(wire_receive_pcs10_signaldetect),
...
defparam
    ...
    receive_pcs10.channel_number = (((starting_channel_number + quad2_starting_channel_number_offset) + 2) % 4),
    receive_pcs10.channel_width = 32,
    receive_pcs10.clk1_mux_select = "recovered clock",
    receive_pcs10.clk2_mux_select = "recovered clock",
    receive_pcs10.core_clock_0ppm = "false",
    ...
    receive_pcs10.logical_channel_address = ((starting_channel_number + quad2_starting_channel_number_offset) + 2),
...
stratixiv_hssi_rx_pcs   receive_pcs11 (
    ...
    .byteorderalignstatus(),
    .cdrctrlearlyeios(),
    .cdrctrllocktorefcl((reconfig_togxb_busy | rx_locktorefclk[quad2_starting_channel_number_offset + 3])),
    ...
    .rxdetectvalid(1'b0),
    .rxfound(2'b00),
    .signaldetect(wire_receive_pcs11_signaldetect),
...
defparam
    ...
    receive_pcs11.channel_number = (((starting_channel_number + quad2_starting_channel_number_offset) + 3) % 4),
    receive_pcs11.channel_width = 32,
    receive_pcs11.clk1_mux_select = "recovered clock",
    receive_pcs11.clk2_mux_select = "recovered clock",
    receive_pcs11.core_clock_0ppm = "false",
    ...
    receive_pcs11.logical_channel_address = ((starting_channel_number + quad2_starting_channel_number_offset) + 3),
...
stratixiv_hssi_rx_pma   receive_pma0 (
    ...
    .datain(rx_datain[quad0_starting_channel_number_offset + 0]),
...
defparam
    ...
    receive_pma0.channel_number = (((starting_channel_number + quad0_starting_channel_number_offset) + 0) % 4),
    ...
    receive_pma0.logical_channel_address = ((starting_channel_number + quad0_starting_channel_number_offset) + 0),
    ...
    receive_pma0.use_external_termination = "true",
...
stratixiv_hssi_rx_pma   receive_pma1 (
    ...
    .datain(rx_datain[quad0_starting_channel_number_offset + 1]),
...
defparam
    ...
    receive_pma1.channel_number = (((starting_channel_number + quad0_starting_channel_number_offset) + 1) % 4),
    receive_pma1.channel_type = "auto",
    receive_pma1.common_mode = "0.82V",
    receive_pma1.deserialization_factor = 16,
    ...
    receive_pma1.logical_channel_address = ((starting_channel_number + quad0_starting_channel_number_offset) + 1),
    ...
    receive_pma1.use_external_termination = "true",
...
stratixiv_hssi_rx_pma   receive_pma2 (
    ...
    .datain(rx_datain[quad0_starting_channel_number_offset + 2]),
...
defparam
    ...
    receive_pma2.channel_number = (((starting_channel_number + quad0_starting_channel_number_offset) + 2) % 4),
    receive_pma2.channel_type = "auto",
    receive_pma2.common_mode = "0.82V",
    receive_pma2.deserialization_factor = 16,
    ...
    receive_pma2.logical_channel_address = ((starting_channel_number + quad0_starting_channel_number_offset) + 2),
    ...
    receive_pma2.use_external_termination = "true",
...
stratixiv_hssi_rx_pma   receive_pma3 (
    ...
    .datain(rx_datain[quad0_starting_channel_number_offset + 3]),
...
defparam
    ...
    receive_pma3.channel_number = (((starting_channel_number + quad0_starting_channel_number_offset) + 3) % 4),
    receive_pma3.channel_type = "auto",
    receive_pma3.common_mode = "0.82V",
    receive_pma3.deserialization_factor = 16,
    ...
    receive_pma3.logical_channel_address = ((starting_channel_number + quad0_starting_channel_number_offset) + 3),
    ...
    receive_pma3.use_external_termination = "true",
...
stratixiv_hssi_rx_pma   receive_pma4 (
    ...
    .datain(rx_datain[quad1_starting_channel_number_offset + 0]),
...
defparam
    ...
    receive_pma4.channel_number = (((starting_channel_number + quad1_starting_channel_number_offset) + 0) % 4),
    receive_pma4.channel_type = "auto",
    receive_pma4.common_mode = "0.82V",
    receive_pma4.deserialization_factor = 16,
    receive_pma4.dprio_config_mode = 6'h01,
    receive_pma4.enable_ltd = "true",
    ...
    receive_pma4.logical_channel_address = ((starting_channel_number + quad1_starting_channel_number_offset) + 0),
	...
	receive_pma4.signal_detect_hysteresis = 2,
    receive_pma4.signal_detect_hysteresis_valid_threshold = 1,
    receive_pma4.signal_detect_loss_threshold = 1,
    receive_pma4.termination = "OCT 85 Ohms",
    receive_pma4.use_deser_double_data_width = "true",
    receive_pma4.use_external_termination = "true",
...
stratixiv_hssi_rx_pma   receive_pma5 (
    ...
    .datain(rx_datain[quad1_starting_channel_number_offset + 1]),
...
defparam
    ...
    receive_pma5.channel_number = (((starting_channel_number + quad1_starting_channel_number_offset) + 1) % 4),
    receive_pma5.channel_type = "auto",
    receive_pma5.common_mode = "0.82V",
    receive_pma5.deserialization_factor = 16,
    receive_pma5.dprio_config_mode = 6'h01,
    receive_pma5.enable_ltd = "true",
    ...
    receive_pma5.logical_channel_address = ((starting_channel_number + quad1_starting_channel_number_offset) + 1),
	...
	receive_pma5.signal_detect_hysteresis = 2,
    receive_pma5.signal_detect_hysteresis_valid_threshold = 1,
    receive_pma5.signal_detect_loss_threshold = 1,
    receive_pma5.termination = "OCT 85 Ohms",
    receive_pma5.use_deser_double_data_width = "true",
    receive_pma5.use_external_termination = "true",
...
stratixiv_hssi_rx_pma   receive_pma6 (
    ...
    .datain(rx_datain[quad1_starting_channel_number_offset + 2]),
...
defparam
    ...
    receive_pma6.channel_number = (((starting_channel_number + quad1_starting_channel_number_offset) + 2) % 4),
    receive_pma6.channel_type = "auto",
    receive_pma6.common_mode = "0.82V",
    receive_pma6.deserialization_factor = 16,
    receive_pma6.dprio_config_mode = 6'h01,
    receive_pma6.enable_ltd = "true",
    ...
    receive_pma6.logical_channel_address = ((starting_channel_number + quad1_starting_channel_number_offset) + 2),
	...
	receive_pma6.signal_detect_hysteresis = 2,
    receive_pma6.signal_detect_hysteresis_valid_threshold = 1,
    receive_pma6.signal_detect_loss_threshold = 1,
    receive_pma6.termination = "OCT 85 Ohms",
    receive_pma6.use_deser_double_data_width = "true",
    receive_pma6.use_external_termination = "true",
...
stratixiv_hssi_rx_pma   receive_pma7 (
    ...
    .datain(rx_datain[quad1_starting_channel_number_offset + 3]),
...
defparam
    ...
    receive_pma7.channel_number = (((starting_channel_number + quad1_starting_channel_number_offset) + 3) % 4),
    receive_pma7.channel_type = "auto",
    receive_pma7.common_mode = "0.82V",
    receive_pma7.deserialization_factor = 16,
    receive_pma7.dprio_config_mode = 6'h01,
    receive_pma7.enable_ltd = "true",
    ...
    receive_pma7.logical_channel_address = ((starting_channel_number + quad1_starting_channel_number_offset) + 3),
	...
	receive_pma7.signal_detect_hysteresis = 2,
    receive_pma7.signal_detect_hysteresis_valid_threshold = 1,
    receive_pma7.signal_detect_loss_threshold = 1,
    receive_pma7.termination = "OCT 85 Ohms",
    receive_pma7.use_deser_double_data_width = "true",
    receive_pma7.use_external_termination = "true",
...
stratixiv_hssi_rx_pma   receive_pma8 (
    ...
    .datain(rx_datain[quad2_starting_channel_number_offset + 0]),
...
defparam
    receive_pma8.adaptive_equalization_mode = "none",
    receive_pma8.allow_serial_loopback = "false",
    receive_pma8.channel_number = (((starting_channel_number + quad2_starting_channel_number_offset) + 0) % 4),
    receive_pma8.channel_type = "auto",
    receive_pma8.common_mode = "0.82V",
    receive_pma8.deserialization_factor = 16,
    receive_pma8.dprio_config_mode = 6'h01,
    receive_pma8.enable_ltd = "true",
    receive_pma8.enable_ltr = "true",
    ...
    receive_pma8.eyemon_bandwidth = 0,
    receive_pma8.force_signal_detect = "true",
    receive_pma8.logical_channel_address = ((starting_channel_number + quad2_starting_channel_number_offset) + 0),
    receive_pma8.low_speed_test_select = 0,
    receive_pma8.offset_cancellation = 1,
    receive_pma8.ppmselect = 32,
    receive_pma8.protocol_hint = "basic",
    receive_pma8.send_direct_reverse_serial_loopback = "None",
	receive_pma8.signal_detect_hysteresis = 2,
    receive_pma8.signal_detect_hysteresis_valid_threshold = 1,
    receive_pma8.signal_detect_loss_threshold = 1,
    receive_pma8.termination = "OCT 85 Ohms",
    receive_pma8.use_deser_double_data_width = "true",
    receive_pma8.use_external_termination = "true",
...
stratixiv_hssi_rx_pma   receive_pma9 (
    ...
    .datain(rx_datain[quad2_starting_channel_number_offset + 1]),
...
defparam
    receive_pma9.adaptive_equalization_mode = "none",
    receive_pma9.allow_serial_loopback = "false",
    receive_pma9.channel_number = (((starting_channel_number + quad2_starting_channel_number_offset) + 1) % 4),
    receive_pma9.channel_type = "auto",
    receive_pma9.common_mode = "0.82V",
    receive_pma9.deserialization_factor = 16,
    receive_pma9.dprio_config_mode = 6'h01,
    receive_pma9.enable_ltd = "true",
    receive_pma9.enable_ltr = "true",
    ...
    receive_pma9.eyemon_bandwidth = 0,
    receive_pma9.force_signal_detect = "true",
    receive_pma9.logical_channel_address = ((starting_channel_number + quad2_starting_channel_number_offset) + 1),
    receive_pma9.low_speed_test_select = 0,
    receive_pma9.offset_cancellation = 1,
    receive_pma9.ppmselect = 32,
    receive_pma9.protocol_hint = "basic",
    receive_pma9.send_direct_reverse_serial_loopback = "None",
	receive_pma9.signal_detect_hysteresis = 2,
    receive_pma9.signal_detect_hysteresis_valid_threshold = 1,
    receive_pma9.signal_detect_loss_threshold = 1,
    receive_pma9.termination = "OCT 85 Ohms",
    receive_pma9.use_deser_double_data_width = "true",
    receive_pma9.use_external_termination = "true",
...
stratixiv_hssi_rx_pma   receive_pma10 (
    ...
    .datain(rx_datain[quad2_starting_channel_number_offset + 2]),
...
defparam
    receive_pma10.adaptive_equalization_mode = "none",
    receive_pma10.allow_serial_loopback = "false",
    receive_pma10.channel_number = (((starting_channel_number + quad2_starting_channel_number_offset) + 2) % 4),
    receive_pma10.channel_type = "auto",
    receive_pma10.common_mode = "0.82V",
    receive_pma10.deserialization_factor = 16,
    receive_pma10.dprio_config_mode = 6'h01,
    receive_pma10.enable_ltd = "true",
    receive_pma10.enable_ltr = "true",
    ...
    receive_pma10.eyemon_bandwidth = 0,
    receive_pma10.force_signal_detect = "true",
    receive_pma10.logical_channel_address = ((starting_channel_number + quad2_starting_channel_number_offset) + 2),
    receive_pma10.low_speed_test_select = 0,
    receive_pma10.offset_cancellation = 1,
    receive_pma10.ppmselect = 32,
    receive_pma10.protocol_hint = "basic",
    receive_pma10.send_direct_reverse_serial_loopback = "None",
	receive_pma10.signal_detect_hysteresis = 2,
    receive_pma10.signal_detect_hysteresis_valid_threshold = 1,
    receive_pma10.signal_detect_loss_threshold = 1,
    receive_pma10.termination = "OCT 85 Ohms",
    receive_pma10.use_deser_double_data_width = "true",
    receive_pma10.use_external_termination = "true",
...
stratixiv_hssi_rx_pma   receive_pma11 (
    ...
    .datain(rx_datain[quad2_starting_channel_number_offset + 3]),
...
defparam
    receive_pma11.adaptive_equalization_mode = "none",
    receive_pma11.allow_serial_loopback = "false",
    receive_pma11.channel_number = (((starting_channel_number + quad2_starting_channel_number_offset) + 3) % 4),
    receive_pma11.channel_type = "auto",
    receive_pma11.common_mode = "0.82V",
    receive_pma11.deserialization_factor = 16,
    receive_pma11.dprio_config_mode = 6'h01,
    receive_pma11.enable_ltd = "true",
    receive_pma11.enable_ltr = "true",
    ...
    receive_pma11.eyemon_bandwidth = 0,
    receive_pma11.force_signal_detect = "true",
    receive_pma11.logical_channel_address = ((starting_channel_number + quad2_starting_channel_number_offset) + 3),
    receive_pma11.low_speed_test_select = 0,
    receive_pma11.offset_cancellation = 1,
    receive_pma11.ppmselect = 32,
    receive_pma11.protocol_hint = "basic",
    receive_pma11.send_direct_reverse_serial_loopback = "None",
	receive_pma11.signal_detect_hysteresis = 2,
    receive_pma11.signal_detect_hysteresis_valid_threshold = 1,
    receive_pma11.signal_detect_loss_threshold = 1,
    receive_pma11.termination = "OCT 85 Ohms",
    receive_pma11.use_deser_double_data_width = "true",
    receive_pma11.use_external_termination = "true",
...
stratixiv_hssi_tx_pcs   transmit_pcs0 (
    ...
    .ctrlenable({4'b0000}),
    .datain({{8{1'b0}}, tx_datain_wire[1 * 32 - 1:0]}),
    ...
    .forceelecidle(tx_forceelecidle[quad0_starting_channel_number_offset + 0]),
...
defparam
    ...
    transmit_pcs0.channel_number = (((starting_channel_number + quad0_starting_channel_number_offset) + 0) % 4),
    ...
    transmit_pcs0.logical_channel_address = ((starting_channel_number + quad0_starting_channel_number_offset) + 0),
...
stratixiv_hssi_tx_pcs   transmit_pcs1 (
    ...
    .ctrlenable({4'b0000}),
    .datain({{8{1'b0}}, tx_datain_wire[2 * 32 - 1:1 * 32]}),
    ...
    .forcedisp({4'b0000}),
    .forcedispcompliance(1'b0),
    .forceelecidle(tx_forceelecidle[quad0_starting_channel_number_offset + 1]),
...
defparam
    ...
    transmit_pcs1.channel_number = (((starting_channel_number + quad0_starting_channel_number_offset) + 1) % 4),
    transmit_pcs1.channel_width = 32,
    ...
    transmit_pcs1.logical_channel_address = ((starting_channel_number + quad0_starting_channel_number_offset) + 1),
...
stratixiv_hssi_tx_pcs   transmit_pcs2 (
    ...
    .ctrlenable({4'b0000}),
    .datain({{8{1'b0}}, tx_datain_wire[3 * 32 - 1:2 * 32]}),
    ...
    .forcedisp({4'b0000}),
    .forcedispcompliance(1'b0),
    .forceelecidle(tx_forceelecidle[quad0_starting_channel_number_offset + 2]),
...
defparam
    ...
    transmit_pcs2.channel_number = (((starting_channel_number + quad0_starting_channel_number_offset) + 2) % 4),
    transmit_pcs2.channel_width = 32,
    ...
    transmit_pcs2.logical_channel_address = ((starting_channel_number + quad0_starting_channel_number_offset) + 2),
...
stratixiv_hssi_tx_pcs   transmit_pcs3 (
    ...
    .ctrlenable({4'b0000}),
    .datain({{8{1'b0}}, tx_datain_wire[4 * 32 - 1:3 * 32]}),
    ...
    .forcedisp({4'b0000}),
    .forcedispcompliance(1'b0),
    .forceelecidle(tx_forceelecidle[quad0_starting_channel_number_offset + 3]),
...
defparam
    ...
    transmit_pcs3.channel_number = (((starting_channel_number + quad0_starting_channel_number_offset) + 3) % 4),
    transmit_pcs3.channel_width = 32,
    ...
    transmit_pcs3.logical_channel_address = ((starting_channel_number + quad0_starting_channel_number_offset) + 3),
...
stratixiv_hssi_tx_pcs   transmit_pcs4 (
    ...
    .ctrlenable({4'b0000}),
    .datain({{8{1'b0}}, tx_datain_wire[5 * 32 - 1:4 * 32]}),
    ...
    .forcedisp({4'b0000}),
    .forcedispcompliance(1'b0),
    .forceelecidle(tx_forceelecidle[quad1_starting_channel_number_offset + 0]),
...
defparam
    ...
    transmit_pcs4.channel_number = (((starting_channel_number + quad1_starting_channel_number_offset) + 0) % 4),
    transmit_pcs4.channel_width = 32,
    ...
    transmit_pcs4.logical_channel_address = ((starting_channel_number + quad1_starting_channel_number_offset) + 0),
...
stratixiv_hssi_tx_pcs   transmit_pcs5 (
    ...
    .ctrlenable({4'b0000}),
    .datain({{8{1'b0}}, tx_datain_wire[6 * 32 - 1:5 * 32]}),
    ...
    .forcedisp({4'b0000}),
    .forcedispcompliance(1'b0),
    .forceelecidle(tx_forceelecidle[quad1_starting_channel_number_offset + 1]),
...
defparam
    ...
    transmit_pcs5.channel_number = (((starting_channel_number + quad1_starting_channel_number_offset) + 1) % 4),
    transmit_pcs5.channel_width = 32,
    ...
    transmit_pcs5.logical_channel_address = ((starting_channel_number + quad1_starting_channel_number_offset) + 1),
...
stratixiv_hssi_tx_pcs   transmit_pcs6 (
    ...
    .ctrlenable({4'b0000}),
    .datain({{8{1'b0}}, tx_datain_wire[7 * 32 - 1:6 * 32]}),
    ...
    .forcedisp({4'b0000}),
    .forcedispcompliance(1'b0),
    .forceelecidle(tx_forceelecidle[quad1_starting_channel_number_offset + 2]),
...
defparam
    ...
    transmit_pcs6.channel_number = (((starting_channel_number + quad1_starting_channel_number_offset) + 2) % 4),
    transmit_pcs6.channel_width = 32,
    ...
    transmit_pcs6.logical_channel_address = ((starting_channel_number + quad1_starting_channel_number_offset) + 2),
...
stratixiv_hssi_tx_pcs   transmit_pcs7 (
    ...
    .ctrlenable({4'b0000}),
    .datain({{8{1'b0}}, tx_datain_wire[8 * 32 - 1:7 * 32]}),
    ...
    .forcedisp({4'b0000}),
    .forcedispcompliance(1'b0),
    .forceelecidle(tx_forceelecidle[quad1_starting_channel_number_offset + 3]),
...
defparam
    ...
    transmit_pcs7.channel_number = (((starting_channel_number + quad1_starting_channel_number_offset) + 3) % 4),
    transmit_pcs7.channel_width = 32,
    ...
    transmit_pcs7.logical_channel_address = ((starting_channel_number + quad1_starting_channel_number_offset) + 3),
...
stratixiv_hssi_tx_pcs   transmit_pcs8 (
    ...
    .ctrlenable({4'b0000}),
    .datain({{8{1'b0}}, tx_datain_wire[9 * 32 - 1:8 * 32]}),
    ...
    .forcedisp({4'b0000}),
    .forcedispcompliance(1'b0),
    .forceelecidle(tx_forceelecidle[quad2_starting_channel_number_offset + 0]),
    .forceelecidleout(wire_transmit_pcs8_forceelecidleout),
    .grayelecidleinferselout(),
    .hiptxclkout(),
...
defparam
    ...
    transmit_pcs8.bitslip_enable = "false",
    transmit_pcs8.channel_bonding = "x8",
    transmit_pcs8.channel_number = (((starting_channel_number + quad2_starting_channel_number_offset) + 0) % 4),
    transmit_pcs8.channel_width = 32,
    transmit_pcs8.core_clock_0ppm = "false",
    ...
    transmit_pcs8.logical_channel_address = ((starting_channel_number + quad2_starting_channel_number_offset) + 0),
...
stratixiv_hssi_tx_pcs   transmit_pcs9 (
    ...
    .ctrlenable({4'b0000}),
    .datain({{8{1'b0}}, tx_datain_wire[10 * 32 - 1:9 * 32]}),
    ...
    .forcedisp({4'b0000}),
    .forcedispcompliance(1'b0),
    .forceelecidle(tx_forceelecidle[quad2_starting_channel_number_offset + 1]),
    .forceelecidleout(wire_transmit_pcs9_forceelecidleout),
    .grayelecidleinferselout(),
    .hiptxclkout(),
...
defparam
    ...
    transmit_pcs9.bitslip_enable = "false",
    transmit_pcs9.channel_bonding = "x8",
    transmit_pcs9.channel_number = (((starting_channel_number + quad2_starting_channel_number_offset) + 1) % 4),
    transmit_pcs9.channel_width = 32,
    transmit_pcs9.core_clock_0ppm = "false",
    ...
    transmit_pcs9.logical_channel_address = ((starting_channel_number + quad2_starting_channel_number_offset) + 1),
...
stratixiv_hssi_tx_pcs   transmit_pcs10 (
    ...
    .ctrlenable({4'b0000}),
    .datain({{8{1'b0}}, tx_datain_wire[11 * 32 - 1:10 * 32]}),
    ...
    .forcedisp({4'b0000}),
    .forcedispcompliance(1'b0),
    .forceelecidle(tx_forceelecidle[quad2_starting_channel_number_offset + 2]),
    .forceelecidleout(wire_transmit_pcs10_forceelecidleout),
    .grayelecidleinferselout(),
    .hiptxclkout(),
...
defparam
    ...
    transmit_pcs10.bitslip_enable = "false",
    transmit_pcs10.channel_bonding = "x8",
    transmit_pcs10.channel_number = (((starting_channel_number + quad2_starting_channel_number_offset) + 2) % 4),
    transmit_pcs10.channel_width = 32,
    transmit_pcs10.core_clock_0ppm = "false",
    ...
    transmit_pcs10.logical_channel_address = ((starting_channel_number + quad2_starting_channel_number_offset) + 2),
...
stratixiv_hssi_tx_pcs   transmit_pcs11 (
    ...
    .ctrlenable({4'b0000}),
    .datain({{8{1'b0}}, tx_datain_wire[12 * 32 - 1:11 * 32]}),
    ...
    .forcedisp({4'b0000}),
    .forcedispcompliance(1'b0),
    .forceelecidle(tx_forceelecidle[quad2_starting_channel_number_offset + 3]),
    .forceelecidleout(wire_transmit_pcs11_forceelecidleout),
    .grayelecidleinferselout(),
    .hiptxclkout(),
...
defparam
    ...
    transmit_pcs11.bitslip_enable = "false",
    transmit_pcs11.channel_bonding = "x8",
    transmit_pcs11.channel_number = (((starting_channel_number + quad2_starting_channel_number_offset) + 3) % 4),
    transmit_pcs11.channel_width = 32,
    transmit_pcs11.core_clock_0ppm = "false",
    ...
    transmit_pcs11.logical_channel_address = ((starting_channel_number + quad2_starting_channel_number_offset) + 3),
...
defparam
    ...
    transmit_pma0.channel_number = (((starting_channel_number + quad0_starting_channel_number_offset) + 0) % 4),
    ...
    transmit_pma0.logical_channel_address = ((starting_channel_number + quad0_starting_channel_number_offset) + 0),
    ...
    transmit_pma0.termination = "OCT 85 Ohms",
    transmit_pma0.use_external_termination = "true",
...
defparam
    ...
    transmit_pma1.channel_number = (((starting_channel_number + quad0_starting_channel_number_offset) + 1) % 4),
    ...
    transmit_pma1.logical_channel_address = ((starting_channel_number + quad0_starting_channel_number_offset) + 1),
    ...
    transmit_pma1.serialization_factor = 16,
    transmit_pma1.slew_rate = "off",
    transmit_pma1.termination = "OCT 85 Ohms",
    transmit_pma1.use_external_termination = "true",
    transmit_pma1.use_pclk = "true",
    transmit_pma1.use_pma_direct = "false",
    transmit_pma1.use_ser_double_data_mode = "true",
    transmit_pma1.vod_selection = 7,
...
defparam
    ...
    transmit_pma2.channel_number = (((starting_channel_number + quad0_starting_channel_number_offset) + 2) % 4),
    ...
    transmit_pma2.logical_channel_address = ((starting_channel_number + quad0_starting_channel_number_offset) + 2),
    ...
    transmit_pma2.serialization_factor = 16,
    transmit_pma2.slew_rate = "off",
    transmit_pma2.termination = "OCT 85 Ohms",
    transmit_pma2.use_external_termination = "true",
    transmit_pma2.use_pclk = "true",
    transmit_pma2.use_pma_direct = "false",
    transmit_pma2.use_ser_double_data_mode = "true",
    transmit_pma2.vod_selection = 7,
...
defparam
    ...
    transmit_pma3.channel_number = (((starting_channel_number + quad0_starting_channel_number_offset) + 3) % 4),
    ...
    transmit_pma3.logical_channel_address = ((starting_channel_number + quad0_starting_channel_number_offset) + 3),
    ...
    transmit_pma3.serialization_factor = 16,
    transmit_pma3.slew_rate = "off",
    transmit_pma3.termination = "OCT 85 Ohms",
    transmit_pma3.use_external_termination = "true",
    transmit_pma3.use_pclk = "true",
    transmit_pma3.use_pma_direct = "false",
    transmit_pma3.use_ser_double_data_mode = "true",
    transmit_pma3.vod_selection = 7,
...
defparam
    ...
    transmit_pma4.channel_number = (((starting_channel_number + quad1_starting_channel_number_offset) + 0) % 4),
    ...
    transmit_pma4.logical_channel_address = ((starting_channel_number + quad1_starting_channel_number_offset) + 0),
    transmit_pma4.logical_protocol_hint_0 = "basic",
    ...
    transmit_pma4.serialization_factor = 16,
    transmit_pma4.slew_rate = "off",
    transmit_pma4.termination = "OCT 85 Ohms",
    transmit_pma4.use_external_termination = "true",
    transmit_pma4.use_pclk = "true",
    transmit_pma4.use_pma_direct = "false",
    transmit_pma4.use_ser_double_data_mode = "true",
    transmit_pma4.vod_selection = 7,
...
defparam
    ...
    transmit_pma5.channel_number = (((starting_channel_number + quad1_starting_channel_number_offset) + 1) % 4),
    ...
    transmit_pma5.logical_channel_address = ((starting_channel_number + quad1_starting_channel_number_offset) + 1),
    transmit_pma5.logical_protocol_hint_0 = "basic",
    ...
    transmit_pma5.serialization_factor = 16,
    transmit_pma5.slew_rate = "off",
    transmit_pma5.termination = "OCT 85 Ohms",
    transmit_pma5.use_external_termination = "true",
    transmit_pma5.use_pclk = "true",
    transmit_pma5.use_pma_direct = "false",
    transmit_pma5.use_ser_double_data_mode = "true",
    transmit_pma5.vod_selection = 7,
...
defparam
    ...
    transmit_pma6.channel_number = (((starting_channel_number + quad1_starting_channel_number_offset) + 2) % 4),
    ...
    transmit_pma6.logical_channel_address = ((starting_channel_number + quad1_starting_channel_number_offset) + 2),
    transmit_pma6.logical_protocol_hint_0 = "basic",
    ...
    transmit_pma6.serialization_factor = 16,
    transmit_pma6.slew_rate = "off",
    transmit_pma6.termination = "OCT 85 Ohms",
    transmit_pma6.use_external_termination = "true",
    transmit_pma6.use_pclk = "true",
    transmit_pma6.use_pma_direct = "false",
    transmit_pma6.use_ser_double_data_mode = "true",
    transmit_pma6.vod_selection = 7,
...
defparam
    ...
    transmit_pma7.channel_number = (((starting_channel_number + quad1_starting_channel_number_offset) + 3) % 4),
    ...
    transmit_pma7.logical_channel_address = ((starting_channel_number + quad1_starting_channel_number_offset) + 3),
    transmit_pma7.logical_protocol_hint_0 = "basic",
    ...
    transmit_pma7.serialization_factor = 16,
    transmit_pma7.slew_rate = "off",
    transmit_pma7.termination = "OCT 85 Ohms",
    transmit_pma7.use_external_termination = "true",
    transmit_pma7.use_pclk = "true",
    transmit_pma7.use_pma_direct = "false",
    transmit_pma7.use_ser_double_data_mode = "true",
    transmit_pma7.vod_selection = 7,
...
stratixiv_hssi_tx_pma   transmit_pma8 (
    ...
    .fastrefclk3in(2'b00),
    .fastrefclk4in(2'b00),
    .forceelecidle(tx_pcs_forceelecidleout[8]),
    .pclk({5{refclk_pma_bi_quad_wire[0]}}),
...
defparam
    ...
    transmit_pma8.channel_number = (((starting_channel_number + quad2_starting_channel_number_offset) + 0) % 4),
    ...
    transmit_pma8.logical_channel_address = ((starting_channel_number + quad2_starting_channel_number_offset) + 0),
    transmit_pma8.logical_protocol_hint_0 = "basic",
    ...
    transmit_pma8.serialization_factor = 16,
    transmit_pma8.slew_rate = "off",
    transmit_pma8.termination = "OCT 85 Ohms",
    transmit_pma8.use_external_termination = "true",
    transmit_pma8.use_pclk = "true",
    transmit_pma8.use_pma_direct = "false",
    transmit_pma8.use_ser_double_data_mode = "true",
    transmit_pma8.vod_selection = 7,
...
stratixiv_hssi_tx_pma   transmit_pma9 (
    ...
    .fastrefclk3in(2'b00),
    .fastrefclk4in(2'b00),
    .forceelecidle(tx_pcs_forceelecidleout[9]),
    .pclk({5{refclk_pma_bi_quad_wire[0]}}),
...
defparam
    ...
    transmit_pma9.channel_number = (((starting_channel_number + quad2_starting_channel_number_offset) + 1) % 4),
    ...
    transmit_pma9.logical_channel_address = ((starting_channel_number + quad2_starting_channel_number_offset) + 1),
    transmit_pma9.logical_protocol_hint_0 = "basic",
    ...
    transmit_pma9.serialization_factor = 16,
    transmit_pma9.slew_rate = "off",
    transmit_pma9.termination = "OCT 85 Ohms",
    transmit_pma9.use_external_termination = "true",
    transmit_pma9.use_pclk = "true",
    transmit_pma9.use_pma_direct = "false",
    transmit_pma9.use_ser_double_data_mode = "true",
    transmit_pma9.vod_selection = 7,
...
stratixiv_hssi_tx_pma   transmit_pma10 (
    ...
    .fastrefclk3in(2'b00),
    .fastrefclk4in(2'b00),
    .forceelecidle(tx_pcs_forceelecidleout[10]),
    .pclk({5{refclk_pma_bi_quad_wire[0]}}),
...
defparam
    ...
    transmit_pma10.channel_number = (((starting_channel_number + quad2_starting_channel_number_offset) + 2) % 4),
    ...
    transmit_pma10.logical_channel_address = ((starting_channel_number + quad2_starting_channel_number_offset) + 2),
    transmit_pma10.logical_protocol_hint_0 = "basic",
    ...
    transmit_pma10.preemp_tap_1 = 21,
    ...
    transmit_pma10.serialization_factor = 16,
    transmit_pma10.slew_rate = "off",
    transmit_pma10.termination = "OCT 85 Ohms",
    transmit_pma10.use_external_termination = "true",
    transmit_pma10.use_pclk = "true",
    transmit_pma10.use_pma_direct = "false",
    transmit_pma10.use_ser_double_data_mode = "true",
    transmit_pma10.vod_selection = 7,
...
stratixiv_hssi_tx_pma   transmit_pma11 (
    ...
    .fastrefclk3in(2'b00),
    .fastrefclk4in(2'b00),
    .forceelecidle(tx_pcs_forceelecidleout[11]),
    .pclk({5{refclk_pma_bi_quad_wire[0]}}),
...
defparam
    ...
    transmit_pma11.channel_number = (((starting_channel_number + quad2_starting_channel_number_offset) + 3) % 4),
    ...
    transmit_pma11.logical_channel_address = ((starting_channel_number + quad2_starting_channel_number_offset) + 3),
    transmit_pma11.logical_protocol_hint_0 = "basic",
    ...
    transmit_pma11.preemp_tap_1 = 21,
    ...
    transmit_pma11.serialization_factor = 16,
    transmit_pma11.slew_rate = "off",
    transmit_pma11.termination = "OCT 85 Ohms",
    transmit_pma11.use_external_termination = "true",
    transmit_pma11.use_pclk = "true",
    transmit_pma11.use_pma_direct = "false",
    transmit_pma11.use_ser_double_data_mode = "true",
    transmit_pma11.vod_selection = 7,
...
assign clk_div_clk0in = {pll0_out[11:0]};
...
assign clk_div_pclkin = {1'b0, refclk_pma[0],
                         1'b0, refclk_pma[0],
                         1'b0, 1'b0};

assign cmu_analogfastrefclkout = {wire_central_clk_div2_analogfastrefclkout,
                                  wire_central_clk_div1_analogfastrefclkout,
                                  wire_central_clk_div0_analogfastrefclkout};

assign cmu_analogrefclkout     = {wire_central_clk_div2_analogrefclkout,
                                  wire_central_clk_div1_analogrefclkout,
                                  wire_central_clk_div0_analogrefclkout};

assign cmu_analogrefclkpulse   = {wire_central_clk_div2_analogrefclkpulse,
...
// connect channel 3 to 4, channel 0 to 11
    ...
    nonusertocmu_out           = {wire_cal_blk2_nonusertocmu,
...
assign pll0_dprioout           = {wire_tx_pll0_dprioout};
...
assign
    ...
    pll_locked                 = {wire_tx_pll0_locked},
    ...
    rx_analogreset_in          = {
        4'b0000,
        ((~ reconfig_togxb_busy) & rx_analogreset[quad2_starting_channel_number_offset + 3]),
        ((~ reconfig_togxb_busy) & rx_analogreset[quad2_starting_channel_number_offset + 2]),
        ((~ reconfig_togxb_busy) & rx_analogreset[quad2_starting_channel_number_offset + 1]),
        ((~ reconfig_togxb_busy) & rx_analogreset[quad2_starting_channel_number_offset + 0]),
        ((~ reconfig_togxb_busy) & rx_analogreset[quad1_starting_channel_number_offset + 3]),
        ((~ reconfig_togxb_busy) & rx_analogreset[quad1_starting_channel_number_offset + 2]),
        ((~ reconfig_togxb_busy) & rx_analogreset[quad1_starting_channel_number_offset + 1]),
        ((~ reconfig_togxb_busy) & rx_analogreset[quad1_starting_channel_number_offset + 0]),
        ((~ reconfig_togxb_busy) & rx_analogreset[quad0_starting_channel_number_offset + 3]),
        ((~ reconfig_togxb_busy) & rx_analogreset[quad0_starting_channel_number_offset + 2]),
        ((~ reconfig_togxb_busy) & rx_analogreset[quad0_starting_channel_number_offset + 1]),
        ((~ reconfig_togxb_busy) & rx_analogreset[quad0_starting_channel_number_offset + 0])},
    ...
    {rx_clkout[(quad2_starting_channel_number_offset + 4) - 1:quad2_starting_channel_number_offset + 0], 
	 rx_clkout[(quad1_starting_channel_number_offset + 4) - 1:quad1_starting_channel_number_offset + 0], 
	 rx_clkout[(quad0_starting_channel_number_offset + 4) - 1:quad0_starting_channel_number_offset + 0]} = {rx_clkout_wire[11:0]},
    ...
    rx_coreclk_in              = {rx_clkout_wire[11:0]},
    ...
    {rx_dataout[(quad2_starting_channel_number_offset + 4) * 32 - 1:quad2_starting_channel_number_offset * 32],
	 rx_dataout[(quad1_starting_channel_number_offset + 4) * 32 - 1:quad1_starting_channel_number_offset * 32],
	 rx_dataout[(quad0_starting_channel_number_offset + 4) * 32 - 1:quad0_starting_channel_number_offset * 32]} = {rx_out_wire[12 * 32 - 1:0]},
    rx_deserclock_in           = {rx_pll_clkout[47:0]},
    rx_digitalreset_in         = {rx_digitalreset[(quad2_starting_channel_number_offset + 4) - 1:quad2_starting_channel_number_offset],
                                  rx_digitalreset[(quad1_starting_channel_number_offset + 4) - 1:quad1_starting_channel_number_offset],
								  rx_digitalreset[(quad0_starting_channel_number_offset + 4) - 1:quad0_starting_channel_number_offset]},
    ...
    rx_locktodata_wire         = {
        ((~ reconfig_togxb_busy) & rx_locktodata[quad2_starting_channel_number_offset + 3]),
        ((~ reconfig_togxb_busy) & rx_locktodata[quad2_starting_channel_number_offset + 2]),
        ((~ reconfig_togxb_busy) & rx_locktodata[quad2_starting_channel_number_offset + 1]),
        ((~ reconfig_togxb_busy) & rx_locktodata[quad2_starting_channel_number_offset + 0]),
        ((~ reconfig_togxb_busy) & rx_locktodata[quad1_starting_channel_number_offset + 3]),
        ((~ reconfig_togxb_busy) & rx_locktodata[quad1_starting_channel_number_offset + 2]),
        ((~ reconfig_togxb_busy) & rx_locktodata[quad1_starting_channel_number_offset + 1]),
        ((~ reconfig_togxb_busy) & rx_locktodata[quad1_starting_channel_number_offset + 0]),
        ((~ reconfig_togxb_busy) & rx_locktodata[quad0_starting_channel_number_offset + 3]),
        ((~ reconfig_togxb_busy) & rx_locktodata[quad0_starting_channel_number_offset + 2]),
        ((~ reconfig_togxb_busy) & rx_locktodata[quad0_starting_channel_number_offset + 1]),
        ((~ reconfig_togxb_busy) & rx_locktodata[quad0_starting_channel_number_offset + 0])},
    ...
    rx_out_wire                = {wire_receive_pcs11_dataout[31:0],
                                  wire_receive_pcs10_dataout[31:0],
                                  wire_receive_pcs9_dataout[31:0],
                                  wire_receive_pcs8_dataout[31:0],
                                  wire_receive_pcs7_dataout[31:0],
                                  wire_receive_pcs6_dataout[31:0],
                                  wire_receive_pcs5_dataout[31:0],
                                  wire_receive_pcs4_dataout[31:0],
                                  wire_receive_pcs3_dataout[31:0],
                                  wire_receive_pcs2_dataout[31:0],
                                  wire_receive_pcs1_dataout[31:0],
                                  wire_receive_pcs0_dataout[31:0]},
    ...
    {rx_phase_comp_fifo_error[(quad2_starting_channel_number_offset + 4) - 1:quad2_starting_channel_number_offset],
     rx_phase_comp_fifo_error[(quad1_starting_channel_number_offset + 4) - 1:quad1_starting_channel_number_offset],
	 rx_phase_comp_fifo_error[(quad0_starting_channel_number_offset + 4) - 1:quad0_starting_channel_number_offset]} = {
    ...
    {rx_pll_locked[(quad2_starting_channel_number_offset + 4) - 1:quad2_starting_channel_number_offset],
     rx_pll_locked[(quad1_starting_channel_number_offset + 4) - 1:quad1_starting_channel_number_offset],
     rx_pll_locked[(quad0_starting_channel_number_offset + 4) - 1:quad0_starting_channel_number_offset]}	 = {
        (rx_plllocked_wire[11] & (~ rx_analogreset[11])),
        (rx_plllocked_wire[10] & (~ rx_analogreset[10])),
        (rx_plllocked_wire[9]  & (~ rx_analogreset[9])),
        (rx_plllocked_wire[8]  & (~ rx_analogreset[8])),
        (rx_plllocked_wire[7]  & (~ rx_analogreset[7])),
        (rx_plllocked_wire[6]  & (~ rx_analogreset[6])),
        (rx_plllocked_wire[5]  & (~ rx_analogreset[5])),
        (rx_plllocked_wire[4]  & (~ rx_analogreset[4])),
        (rx_plllocked_wire[3]  & (~ rx_analogreset[3])),
        (rx_plllocked_wire[2]  & (~ rx_analogreset[2])),
        (rx_plllocked_wire[1]  & (~ rx_analogreset[1])),
        (rx_plllocked_wire[0]  & (~ rx_analogreset[0]))},
    ...
    {rx_signaldetect[(quad2_starting_channel_number_offset + 4) - 1:quad2_starting_channel_number_offset],
     rx_signaldetect[(quad1_starting_channel_number_offset + 4) - 1:quad1_starting_channel_number_offset],
     rx_signaldetect[(quad0_starting_channel_number_offset + 4) - 1:quad0_starting_channel_number_offset]}	 = {rx_signaldetectout_wire[11:0]},
    ...
    rx_signaldetectout_wire    = {wire_receive_pcs11_signaldetect,
                                  wire_receive_pcs10_signaldetect,
                                  wire_receive_pcs9_signaldetect,
                                  wire_receive_pcs8_signaldetect,
                                  wire_receive_pcs7_signaldetect,
                                  wire_receive_pcs6_signaldetect,
                                  wire_receive_pcs5_signaldetect,
                                  wire_receive_pcs4_signaldetect,
                                  wire_receive_pcs3_signaldetect,
                                  wire_receive_pcs2_signaldetect,
                                  wire_receive_pcs1_signaldetect,
                                  wire_receive_pcs0_signaldetect},
    rxpll_dprioin              = {{600'b0},
                                  cent_unit_cmuplldprioout[4799:3600],
                                  {600'b0},
                                  cent_unit_cmuplldprioout[2999:1800],
                                  {600'b0},
                                  cent_unit_cmuplldprioout[1199:0]},
    ...
    tx_coreclk_in              = {12{coreclkout_bi_quad_wire[0]}},
    tx_datain_wire             = {tx_datain[(quad2_starting_channel_number_offset + 4) * 32 - 1:quad2_starting_channel_number_offset * 32],
	                              tx_datain[(quad1_starting_channel_number_offset + 4) * 32 - 1:quad1_starting_channel_number_offset * 32],
								  tx_datain[(quad0_starting_channel_number_offset + 4) * 32 - 1:quad0_starting_channel_number_offset * 32]},
    tx_datainfull              = {527'b0},
    {tx_dataout[(quad2_starting_channel_number_offset + 4) - 1:quad2_starting_channel_number_offset],
     tx_dataout[(quad1_starting_channel_number_offset + 4) - 1:quad1_starting_channel_number_offset],
     tx_dataout[(quad0_starting_channel_number_offset + 4) - 1:quad0_starting_channel_number_offset]} = {wire_transmit_pma11_dataout,
    ...
    tx_digitalreset_in         = {12{int_tx_digitalreset_reg[0]}},
    ...
    tx_pcs_forceelecidleout    = {wire_transmit_pcs11_forceelecidleout,
                                  wire_transmit_pcs10_forceelecidleout,
                                  wire_transmit_pcs9_forceelecidleout,
                                  wire_transmit_pcs8_forceelecidleout,
                                  wire_transmit_pcs7_forceelecidleout,
                                  wire_transmit_pcs6_forceelecidleout,
                                  wire_transmit_pcs5_forceelecidleout,
    ...
    {tx_phase_comp_fifo_error[(quad2_starting_channel_number_offset + 4) - 1:quad2_starting_channel_number_offset],
     tx_phase_comp_fifo_error[(quad1_starting_channel_number_offset + 4) - 1:quad1_starting_channel_number_offset],
     tx_phase_comp_fifo_error[(quad0_starting_channel_number_offset + 4) - 1:quad0_starting_channel_number_offset]}	 = {
...
wire [50:0]  sub_wire7;
wire [0:0]   sub_wire8;
wire [12 * 32 - 1:0] sub_wire9;
wire [11:0]  sub_wire10;
...
wire [11:0]  rx_signaldetect           = sub_wire10[11:0];
wire [50:0]  reconfig_fromgxb          = sub_wire7[50:0];
wire [0:0]   pll_locked                = sub_wire8[0:0];
wire [12 * 32 - 1:0] rx_dataout        = sub_wire9[12 * 32 - 1:0];
