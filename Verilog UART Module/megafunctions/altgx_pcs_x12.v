...
defparam
	...
	receive_pma8.signal_detect_hysteresis = 4,
    receive_pma8.signal_detect_hysteresis_valid_threshold = 2,
    receive_pma8.signal_detect_loss_threshold = 3,
...
defparam
	...
	receive_pma9.signal_detect_hysteresis = 4,
    receive_pma9.signal_detect_hysteresis_valid_threshold = 2,
    receive_pma9.signal_detect_loss_threshold = 3,
...
defparam
	...
	receive_pma10.signal_detect_hysteresis = 4,
    receive_pma10.signal_detect_hysteresis_valid_threshold = 2,
    receive_pma10.signal_detect_loss_threshold = 3,
...
defparam
	...
	receive_pma11.signal_detect_hysteresis = 4,
    receive_pma11.signal_detect_hysteresis_valid_threshold = 2,
    receive_pma11.signal_detect_loss_threshold = 3,
...
//ishimony 2009-07-30    refclk_pma_bi_quad_wire    = {refclk_pma[0]},
    refclk_pma_bi_quad_wire    = (lc_pll == "true") ?
                                 {lc_clk} : {refclk_pma[0]},
